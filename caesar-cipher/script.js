function main(x) {
  // x identifies from which button call is being made: Encrypt or Decrypt
...
function isUpperCase(str) {
  // function to check if letter/word is uppercase or not
  return str === str.toUpperCase();
}

function change(ch, key) {
  // function to shift alphabets according to the key value
  if (!/[a-zA-Z]/.test(ch)) {
    // checks for symbol and returns without any change if found
    return ch;
  }
  if (isUpperCase(ch)) {
